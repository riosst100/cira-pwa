...
export default function Chat() {
    ...
    return (
        <Layout title="Pesan">
            <div className="section mt-1" style={
                {
                    "color":"#27173E",
                    "cursor": "pointer"
                }
                ...
                <Link href="/chat/1">
                    <a>
                        <div className="content p-2">
                            ...
                            <div style={{ "marginLeft": "50px", "color": "grey", "fontSize":"12px" }}>Selamat datang di Cira App.. <span style={{ "float":"right", "fontSize":"10px", "paddingTop":"5px" }}>19:20</span></div>
                            </div>
                        </div>
                    </a>
                </Link>
